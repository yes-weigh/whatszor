                    ...
                    {canAssign && (
                        <div className="relative">
                            <button
                                ...
                                className={`btn btn-sm flex items-center gap-1.5 border ${session.assignedUser
                            ...
                            {showAssignMenu && (
                                ...
                                >
                                    ...
                                    {members.filter((m: any) => m.role !== 'OWNER').map((m: any) => (
                                        <button
                                            key={m.id}
                                            className={`w-full text-left px-4 py-2.5 text-sm hover:bg-hover transition-colors flex items-center gap-2 ${session.userId === m.userId ? 'text-green-600 font-semibold' : 'text-primary'
                                                }`}
